...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init_accessibility_texts(self):
        ...
        self.__ui.program_language_comboBox.setAccessibleName(_translate("Accessibility", "UI language"))
        self.__ui.program_language_comboBox.setAccessibleDescription(_translate("Accessibility", "Select the language of the application interface."))

        self.__ui.select_game_comboBox.setAccessibleName(_translate("Accessibility", "Game"))
        self.__ui.select_game_comboBox.setAccessibleDescription(_translate("Accessibility", "Select the Paradox game you are translating or modding for."))

        self.__ui.game_directory_lineEdit.setAccessibleName(_translate("Accessibility", "Game localization folder"))
        self.__ui.game_directory_lineEdit.setAccessibleDescription(_translate("Accessibility", "Path to the game's localization folder (contains english, russian, etc.)."))
        self.__ui.game_directory_pushButton.setAccessibleName(_translate("Accessibility", "Browse game localization folder"))
        self.__ui.game_directory_pushButton.setAccessibleDescription(_translate("Accessibility", "Open a folder picker to select the game's localization folder."))
        self.__ui.game_directory_open_pushButton.setAccessibleName(_translate("Accessibility", "Open game localization folder"))
        self.__ui.game_directory_open_pushButton.setAccessibleDescription(_translate("Accessibility", "Open the game localization folder in the file explorer."))

        self.__ui.original_directory_lineEdit.setAccessibleName(_translate("Accessibility", "Mod localization folder"))
        self.__ui.original_directory_lineEdit.setAccessibleDescription(_translate("Accessibility", "Path to the original mod localization folder (source files)."))
        self.__ui.original_directory_pushButton.setAccessibleName(_translate("Accessibility", "Browse mod localization folder"))
        self.__ui.original_directory_pushButton.setAccessibleDescription(_translate("Accessibility", "Open a folder picker to select the original mod localization folder."))
        self.__ui.original_directory_open_pushButton.setAccessibleName(_translate("Accessibility", "Open mod localization folder"))
        self.__ui.original_directory_open_pushButton.setAccessibleDescription(_translate("Accessibility", "Open the original mod localization folder in the file explorer."))

        self.__ui.previous_directory_lineEdit.setAccessibleName(_translate("Accessibility", "Previous translation folder"))
        self.__ui.previous_directory_lineEdit.setAccessibleDescription(_translate("Accessibility", "Optional. Path to a previous translation version to reuse already translated lines."))
        self.__ui.previous_directory_pushButton.setAccessibleName(_translate("Accessibility", "Browse previous translation folder"))
        self.__ui.previous_directory_pushButton.setAccessibleDescription(_translate("Accessibility", "Open a folder picker to select the previous translation folder."))
        self.__ui.previous_directory_open_pushButton.setAccessibleName(_translate("Accessibility", "Open previous translation folder"))
        self.__ui.previous_directory_open_pushButton.setAccessibleDescription(_translate("Accessibility", "Open the previous translation folder in the file explorer."))

        self.__ui.target_directory_lineEdit.setAccessibleName(_translate("Accessibility", "Output folder"))
        self.__ui.target_directory_lineEdit.setAccessibleDescription(_translate("Accessibility", "Output folder where generated localization files will be saved."))
        self.__ui.target_directory_pushButton.setAccessibleName(_translate("Accessibility", "Browse output folder"))
        self.__ui.target_directory_pushButton.setAccessibleDescription(_translate("Accessibility", "Open a folder picker to select the output folder."))
        self.__ui.target_directory_open_pushButton.setAccessibleName(_translate("Accessibility", "Open output folder"))
        self.__ui.target_directory_open_pushButton.setAccessibleDescription(_translate("Accessibility", "Open the output folder in the file explorer."))

        self.__ui.selector_original_language_comboBox.setAccessibleName(_translate("Accessibility", "Source language"))
        self.__ui.selector_original_language_comboBox.setAccessibleDescription(_translate("Accessibility", "Language of the original strings to process (e.g., english)."))
        self.__ui.selector_target_language_comboBox.setAccessibleName(_translate("Accessibility", "Target language"))
        self.__ui.selector_target_language_comboBox.setAccessibleDescription(_translate("Accessibility", "Language for the translated output (e.g., italian)."))
        self.__ui.selector_game_supported_source_language_comboBox.setAccessibleName(_translate("Accessibility", "Mod source language folder"))
        self.__ui.selector_game_supported_source_language_comboBox.setAccessibleDescription(_translate("Accessibility", "Language subfolder inside the mod localization directory used as source."))
        self.__ui.selector_game_supported_target_language_comboBox.setAccessibleName(_translate("Accessibility", "Mod target language folder"))
        self.__ui.selector_game_supported_target_language_comboBox.setAccessibleDescription(_translate("Accessibility", "Language subfolder used for output and/or previous translation lookup."))

        self.__ui.need_translation_checkBox.setAccessibleName(_translate("Accessibility", "Add machine translation"))
        self.__ui.need_translation_checkBox.setAccessibleDescription(_translate("Accessibility", "When enabled, adds machine translation for the selected files."))
        self.__ui.check_all_pushButton.setAccessibleName(_translate("Accessibility", "Select all files"))
        self.__ui.check_all_pushButton.setAccessibleDescription(_translate("Accessibility", "Select all files in the file list below."))
        self.__ui.uncheck_all_pushButton.setAccessibleName(_translate("Accessibility", "Unselect all files"))
        self.__ui.uncheck_all_pushButton.setAccessibleDescription(_translate("Accessibility", "Unselect all files in the file list below."))
        self.__ui.update_need_translation_area_pushButton.setAccessibleName(_translate("Accessibility", "Refresh file list"))
        self.__ui.update_need_translation_area_pushButton.setAccessibleDescription(_translate("Accessibility", "Reload the file list from the selected mod directory."))
        self.__ui.need_translate_scrollArea.setAccessibleName(_translate("Accessibility", "File list"))
        self.__ui.need_translate_scrollArea.setAccessibleDescription(_translate("Accessibility", "List of mod localization files. Check files to include in machine translation."))

        self.__ui.disable_original_line_checkBox.setAccessibleName(_translate("Accessibility", "Disable original line output"))
        self.__ui.disable_original_line_checkBox.setAccessibleDescription(_translate("Accessibility", "Advanced option related to how original lines are written when machine translation is enabled."))
        self.__ui.run_pushButton.setAccessibleName(_translate("Accessibility", "Start"))
        self.__ui.run_pushButton.setAccessibleDescription(_translate("Accessibility", "Start generating the output localization files."))

        self.__ui.discord_link_pushButton.setAccessibleName(_translate("Accessibility", "Discord server"))
        self.__ui.discord_link_pushButton.setAccessibleDescription(_translate("Accessibility", "Open the Discord server for support and bug reports."))
        self.__ui.donate_pushButton.setAccessibleName(_translate("Accessibility", "Donate"))
        self.__ui.donate_pushButton.setAccessibleDescription(_translate("Accessibility", "Open the donation page to support the project."))
